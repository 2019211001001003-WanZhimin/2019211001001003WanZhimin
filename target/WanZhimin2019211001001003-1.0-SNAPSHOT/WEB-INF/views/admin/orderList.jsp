			...
			<table class="table table-condensed">
				...
				<c:forEach var="o" items="${orderList}">
					<tr>
						...
						<td>${o.orderDate}</td>
					<%
						com.WanZhimin.model.Order o=(com.WanZhimin.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
						com.WanZhimin.dao.UserDao userDao=new com.WanZhimin.dao.UserDao();
					...
					<td class="cart_total">
						<%
							...
							String paymentType=com.WanZhimin.model.Payment.findByPaymentId(con,n);
						%>
