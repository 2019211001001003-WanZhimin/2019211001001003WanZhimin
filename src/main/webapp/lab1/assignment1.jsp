<%@ page import="com.WanZhimin.lab1.Person" %>
<%@ page import="java.util.ArrayList" %>
<%@ page import="java.util.List" %>
<%@ page import="com.WanZhimin.lab1.Dog" %><%--
...
<h1>1.use c:forEach to print 1 to 10</h1>
<ul>
...
<h1>2.use c:forEach to print list 1,3,5,7,9</h1>
    <ul>
...
<h1>3.use c:forEach to print 2,4,6,8,10</h1>
    <ul>
        <c:forEach var="i" begin="1" step="2" end="10">
        <li>${i+1}</li>
        </c:forEach>
...
<h1>4. use c:forEach to print all elements of array</h1>
    <ul>
...
<h1>5. use c:forEach to print "one","three","five","seven","nine"  of array</h1>
    <ul>
...
<h1>6. add a new person into PersonList - person name and dog name</h1>
    <h3>add: WanZhimin -- Bruce</h3>
<%
List<Person> personList=new ArrayList<Person>();
personList.add(new Person("Tom",new Dog("Tommy")));
personList.add(new Person("Sam",new Dog("Sammy")));
personList.add(new Person("WanZhimin",new Dog("Bruce")));
...
<h1>7. use c:forEach to print person name :   and persons' dog name :</h1>
...
<h1>8. use c:forToken to print all words</h1>
